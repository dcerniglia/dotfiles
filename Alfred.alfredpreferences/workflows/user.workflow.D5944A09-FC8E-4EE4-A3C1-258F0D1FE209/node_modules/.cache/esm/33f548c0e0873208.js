let alfredError,apiCall,getToday,roundTime;_e08‍.w("./utils/errors",[["alfredError",["alfredError"],function(v){alfredError=v}]]);_e08‍.w("./utils/helpers",[["apiCall",["apiCall"],function(v){apiCall=v}]]);_e08‍.w("./utils/time",[["getToday",["getToday"],function(v){getToday=v}],["roundTime",["roundTime"],function(v){roundTime=v}]]);
