...
let NoteWorkspace = /** @class */ (() => {
    ...
    NoteWorkspace._rxTagNoAnchors = '\\#[\\w\\-\\_]+'; // used to match tags that appear within lines
    NoteWorkspace._rxTagWithAnchors = '^\\#[\\w\\-\\_]+$'; // used to match entire words
    ...
    NoteWorkspace._rxMarkdownWordPattern = '([\\_\\w\\#\\.\\/\\\\]+)'; // had to add [".", "/", "\"] to get relative path completion working and ["#"] to get tag completion working
    NoteWorkspace._rxFileExtensions = '\\.(md|markdown|mdx|fountain)$';
