...
class Note {
    ...
    parseData(useCache = false) {
        ...
        lines.map((line, lineNum) => {
            ...
            Array.from(line.matchAll(NoteWorkspace_1.NoteWorkspace.rxTagNoAnchors())).map((match) => {
    ...
    _rawRangesForWord(ref) {
        ...
        if (![Ref_1.RefType.Tag, Ref_1.RefType.WikiLink].includes(ref.type)) {
            return [];
        }
...
let NoteParser = /** @class */ (() => {
    class NoteParser {
        ...
        static searchBacklinksFor(fileBasename) {
            return __awaiter(this, void 0, void 0, function* () {
                let ref = {
