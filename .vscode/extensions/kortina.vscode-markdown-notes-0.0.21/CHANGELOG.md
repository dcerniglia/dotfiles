...
- fix bug where `[[Link/Topic]]` would not correctly find note namec `link-topic.md`. tx to @eBerdnA for [#52](https://github.com/kortina/vscode-markdown-notes/issues/52) closes [#50](https://github.com/kortina/vscode-markdown-notes/issues/50)
