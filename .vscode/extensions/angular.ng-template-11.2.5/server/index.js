...
define(['fs', 'path', 'typescript/lib/tsserverlibrary', '@angular/language-service/api', 'assert', 'vscode-languageserver/node', 'vscode-jsonrpc', 'vscode-languageserver-protocol', 'vscode-languageserver', 'vscode-uri', 'child_process'], function (fs, path, tsserverlibrary, api, assert, node, vscodeJsonrpc, vscodeLanguageserverProtocol, vscodeLanguageserver, vscodeUri, child_process) { 'use strict';
